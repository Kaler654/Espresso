...
import sqlite3
from Form_add_element import Ui_add_MainWindow
from Form_change_element import Ui_change_MainWindow
...
class FormAddFilm(QMainWindow, Ui_add_MainWindow):
...
class FormChangeFilm(QMainWindow, Ui_change_MainWindow):
